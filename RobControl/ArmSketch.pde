...
{
    // constants
    public static final int SHOULDER_HEIGHT = 100;
    public static final int LOWER_ARM_LENGTH = 80;
    public static final int UPPER_ARM_LENGTH = 80;
    ...
    void setup()
    {
        ...
        shoulder = new PVector(0, SHOULDER_HEIGHT);
    ...
    { 
        ...
        sp1.x = p1.x + (a/d) * dx - (h/d) * dy;   // Schnittpunkt 1 
        sp1.y = p1.y + (a/d) * dy + (h/d) * dx; 
        sp1.z = p1.z;                             // Z-koordinate übernehmen 
